...
Implicitly runs the "ls" command on the result to display details about the package.

```
vagrant@hyperledger-devenv:v0.0.7-2ec7137:~ $ chaintool package -p /opt/gopath/src/github.com/hyperledger/fabric/examples/chaincode/chaintool/example02/
Writing CAR to: /opt/gopath/src/github.com/hyperledger/fabric/examples/chaincode/chaintool/example02/build/org.hyperledger.chaincode.example02-0.1-SNAPSHOT.car
Using path /opt/gopath/src/github.com/hyperledger/fabric/examples/chaincode/chaintool/example02/ ["src" "chaincode.yaml"]
|------+------------------------------------------+--------------------------------------------------------|
| Size |                   SHA1                   |                      Path                              |
|------+------------------------------------------+--------------------------------------------------------|
...
Displays the contents of an existing .car file (see 'chaintool package' for an output example)
