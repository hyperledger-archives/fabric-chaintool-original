...
Actions:
  ...
  ls -> List the contents of a CCA file
...
Other commands such as _buildcca_, _unpack_, and _ls_ are designed to operate against a Chaincode Archive (CCA) from a previous _package_ operation.  These commands expect a path to a CCA file.
